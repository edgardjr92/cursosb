...
public class Pedido implements Serializable, GenericDomain<Integer> {
	...
	public Pedido(Integer id, Date createdAt, Cliente cliente, Endereco enderecoEntrega) {
		super();
		this.id = id;
